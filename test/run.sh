...
# nohup /usr/bin/time -v mpiexec -n 16 ./FANS input_files/test_linear_elastic.json test_results.h5 > nohup.out 2>&1 &

nohup /usr/bin/time -v mpiexec -n 16 ./FANS input_files/test_linear_thermal.json test_results.h5 > nohup.out 2>&1 &